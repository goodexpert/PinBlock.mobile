...
class PinBlockTests {
    ...
    companion object {
        ...
        const val ENCODED_PIN_3 = "3412AC9A8A98DE52"
        ...
        val ENCODED_PIN_BYTES_3 = arrayOf(0x34, 0x12, 0xAC, 0x9A, 0x8A, 0x98, 0xDE, 0x52).map { it.toByte() }.toTypedArray()
        val ENCODED_PIN_SIZE = 16
    }
    ...
    fun testISOFormat0() {
        ...
        val pinBytes = PinBlock.decode(PinBlock.Format.ISO_0, PAN_BYTES, PAN_SIZE, encodedPinBytes, ENCODED_PIN_SIZE)
    ...
    fun testISOFormat3() {
        ...
        val pinBytes = PinBlock.decode(PinBlock.Format.ISO_3, PAN_BYTES, PAN_SIZE, encodedPinBytes, ENCODED_PIN_SIZE)
        assertEquals(true, PIN_BYTES contentEquals pinBytes, "We're expected $PIN_BYTES, but it returns $pinBytes")
    }
}